export const recipes = [
  ...
  },
  {
    ...
    time: 30,
    description:
      'Faire revenir le poulet dans une poêle. Ajouter le curry, le lait de coco et la crème. Laisser mijoter 10 minutes',
    appliance: 'Poêle',
    ustensils: ['cuillère en bois']
  },
  {
    ...
    time: 60,
    description:
      "Faire cuire le riz. Étaler le riz sur une feuille d'algue. Ajouter le saumon et l'avocat. Rouler l'ensemble. Couper en tronçon. Servir avec la sauce soja",
    appliance: 'Cuiseur de riz',
    ustensils: ['natte en bambou', 'couteau']
  },
  {
    id: 53,
    image: 'Recette53.jpg',
    ...
    time: 50,
    description:
      'Étaler la pate brisée dans un moule. La faire cuire à blanc 15 minutes. Laisser refroidir. Étaler la crème pâtissière sur le fond de tarte. Disposer les fraises. Mettre au frais',
    appliance: 'Four',
    ustensils: ['rouleau à patisserie', 'fouet', 'moule à tarte']
  },
  {
    id: 54,
    image: 'Recette54.jpg',
    ...
    time: 30,
    description:
      'Mélanger les jaunes d’œufs avec le sucre. Ajouter le mascarpone. Battre les blancs en neige. Mélanger les deux préparations. Tremper les boudoirs dans le café et les disposer dans un plat. Ajouter une couche de crème puis une autre de boudoirs. Mettre au frais. Saupoudrer de cacao avant de servir',
    appliance: 'Saladier',
    ustensils: ['fouet', 'spatule', 'casserole']
  }
]
